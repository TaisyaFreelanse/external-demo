<template>
  <div class="min-h-screen bg-gradient-to-br from-[#0A0F1E] via-[#1A1F2E] to-[#0A0F1E] text-white">
    <div class="container mx-auto px-4 pt-4 pb-8 max-w-[1200px]">
      ...
      <!-- Инструкция -->
      <div class="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-2xl p-6 mb-6">
        <h2 class="text-2xl font-semibold mb-4 text-white">📖 Инструкция по использованию External API</h2>
        
        <div class="space-y-4 text-white/90 text-sm">
          <div>
            <h3 class="font-semibold text-white mb-2">1. Создание и сохранение Ивента</h3>
            <p class="text-white/80 mb-2">
              Заполните форму ниже и нажмите кнопку <strong>"💾 Сохранить"</strong>. Ивент будет сохранен локально в браузере.
